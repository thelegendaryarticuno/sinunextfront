...
const PrivacyPolicy = () => {
  ...
  return (
    <div
      className={`${backgroundColor} ${textColor} p-8 mx-2 my-4 space-y-8 mt-16`}
    >
      ...
      <div
        className={`flex flex-col md:flex-row md:justify-between ${borderColor} pb-4`}
      >
        <h3 className="text-lg font-semibold md:w-1/3">
        ...
        <div className="md:w-2/3 mt-4 md:mt-0">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              ...
              {
                " (referred to as either 'the Company', 'We', 'Us', or 'Our' in this Agreement) refers to siNUSoid, NIIT University Neemrana Alwar Rajasthan 301705."
              }
            </li>
            <li>
            ...
            <li>
              <span className="font-bold">Country</span> refers to: Rajasthan,
              India
            </li>
            <li>
            ...
            <li>
              <span className="font-bold">Website</span> refers to siNUSoid,
              accessible from{" "}
              <a href="https://sinusoid.in" className="text-blue-500 underline">
                https://sinusoid.in
              </a>
            </li>
            <li>
      ...
      >
        ...
        <div className="md:w-2/3 mt-4 md:mt-0">
          ...
          <ul className="list-disc pl-5 mb-6">
            ...
            <li className="mb-2">
              <strong>To provide You with</strong>{" "}
              {
        ...
        <div className="md:w-2/3 mt-4 md:mt-0">
          ...
          <ul className="list-disc pl-5 space-y-2">
            ...
            <li>
              ...
              <Link
                href="https://sinusoid.in"
                className="text-purple-600 underline"
              >
                https://sinusoid.in
              </Link>
            </li>
            <li>By phone number: +91 7016803160</li>
          </ul>
          <p className="mt-2">
            Our privacy policies are subject to change. All updates will appear
            on this page.{" "}
          </p>
        </div>
      </div>
