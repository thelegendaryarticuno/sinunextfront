...
const SplitSection = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-full md:h-screen mt-16">
      <div className={`hidden md:block w-1/2 ${leftSplitColor} p-12 flex flex-col justify-center items-center`}>
      ...
      <div className={`w-full md:w-1/2 ${rightSplitColor} p-6 md:p-12 flex flex-col justify-center md:h-auto overflow-auto`}>
        <h2 className={`text-3xl text-center  md:text-4xl font-bold mb-4 ${textColor}`}>Contact Us</h2>
        <p className="text-base md:text-lg mb-6"> Use the form below to get in touch.</p>
