      ...
      <div className="pl-4">
        ...
        <div className="flex flex-wrap justify-between gap-4 mt-12">
          ...
          <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg flex-1 min-w-[30%]">
            ...
            - You will be allowed to board the bus only after you show the mail for the
            Registration, Student identity card, and a copy of your Aadhar card for verification.<br />
            - The drop-off for all participants will take place on November 11th, 2024, and the same bus will leave for IFFCO CHOWK from the university campus at 7:00 AM. <br />
            - Please note that once the journey begins, the bus will not make any stops along the way, except in case of an emergency.
          ...
          <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg flex-1 min-w-[30%]">
            ...
            <p className="text-sm font-normal">
              ...
              The timings for the same are as follows:
            </p>
            ...
            - An additional cost has to be paid in case you require an extra meal.<br />
            - A token for the same will be provided to you after the payment.
            Stalls will be open from 4pm.<br />
            Note :<br />
            1. Meals mentioned in your package from the mess menu will be available, and are available at no additional cost.<br />
            2. Other food options are available which include stalls and cafes on campus,the cost for which is not included in any plan. In case you wish to avail these facilities,you must do so at your own expense.
          ...
          <div className="bg-gray-800 text-white p-6 rounded-lg shadow-lg flex-1 min-w-[30%]">
            ...
            <p className="text-sm font-normal mt-4 whitespace-pre-line">
              ...
              detectors in every room. Strict actions will be taken if anyone is
            ...
            <p className="text-sm font-normal whitespace-pre-line">
              ...
              have received bands will be allowed entry to the designated area.
            </p>
          </div>
        </div>
        <div className="mt-12">
          ...
          <ul className="list-disc list-inside text-black dark:text-white space-y-2">
            ...
            Ragging is strictly banned in the University, and anyone found guilty of ragging and/or abetting ragging, 
            whether actively or passively, or being a part of a conspiracy to promote ragging, is liable to be punished 
            in accordance with the UGC Regulations on Curbing the Menace of Ragging in Higher Educational Institutions. 
            Any instance of Ragging should be reported immediately.
            </li>
            <li className="text-sm">
            ...
            Students indulging in such acts would invite strict disciplinary action and would be mandatorily required to
            compensate the loss incurred if any to the University property.
            </li>
            <li className="text-sm">
            No disturbance of any type (loud music, noise etc.) is encouraged, especially post 11 PM.
            </li>
            <li className="text-sm">
            Possession/Consumption of alcohol,drugs is prohibited.If any cigarettes/bidis/hookah and alcohol/any narcotic
            substance are found in campus, all occupants of the area will be held responsible.
            </li>
            <li className="text-sm">
            No student is permitted to enter Campus if s/he has consumed alcohol or any narcotic substance outside the Campus.
            </li>
            <li className="text-sm">
            Any incidence of willful assault on any student, faculty or staff of NU or any vendors on campus will invite strict disciplinary action.
            </li>
            <li className="text-sm">
            Behavior: Any acts of violence or sexual harassment will not be tolerated and could lead to severe repercussions 
            for both the individual and their college.
            </li>
            <li className="text-sm">
            CCTV Cameras are installed at entrances, common areas and corridors.
            </li>
            <li className="text-sm">
            Event timeline will remain same, regardless of the plan selected.
            </li>
            <li className="text-sm">
            Common facilities on sharing basis:
           Washroom, Shower, Washbasin and RO treated drinking water, including
           hot water for drinking.
            </li>
            <li className="text-sm">
            Students are strongly advised to keep the room key safely and not to share with others
            </li>
            <li className="text-sm">
            NU is a plastic-free campus, and littering/disposing off of polythene bags, sachets of eatable etc is not permitted
            </li>
            <li className="text-sm">
            Take care of your valuables like laptop, wristwatch, cell phone, camera, wallet, etc. No person from the university 
            or the administration will be held responsible for any lost item(s).
            </li>
            <p className="text-lg font-bold">
              Your cooperation in maintaining a safe and enjoyable environment is greatly appreciated.
              </p>
          </ul>
        </div>
      </div>
